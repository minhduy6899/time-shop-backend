          ...
          <div className='row'>
            <div className='col-lg-4'>
              <div className='categories_post'>
                <img src='image/blog1.jpg' alt='post' />
            ...
            <div className='col-lg-4'>
              <div className='categories_post'>
                <img src='image/blog2.jpg' alt='post' />
                <div className='categories_details'>
                  <div className='categories_text'>
                    <a href='blog-details.html'>
                      <h5>Luxury</h5>
            ...
            <div className='col-lg-4'>
              <div className='categories_post'>
                <img src='image/blog3.jpg' alt='post' />
                <div className='categories_details'>
                  <div className='categories_text'>
                    <a href='blog-details.html'>
                      <h5>Right band</h5>
                    ...
                    <div className='border_line'></div>
                    <p>How to pick up the right band</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className='blog_right_sidebar'>
                ...
                <aside className='single_sidebar_widget popular_post_widget'>
                  ...
                  <div className='media post_item'>
                    <img src='image/w85.jpg' alt='post' />
                  ...
                  <div className='media post_item'>
                    <img src='image/w86.jpg' alt='post' />
                    <div className='media-body'>
                      <a href='blog-details.html'>
                  ...
                  <div className='media post_item'>
                    <img src='image/w87.jpg' alt='post' />
                    <div className='media-body'>
                      <a href='blog-details.html'>
                  ...
                  <div className='media post_item'>
                    <img src='image/w88.jpg' alt='post' />
                    <div className='media-body'>
                      <a href='blog-details.html'>
